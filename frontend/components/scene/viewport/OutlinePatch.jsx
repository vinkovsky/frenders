...
const OutlinePass = ( resolution, scene, camera, selectedObjects ) => {

    const { CopyShader } = require( "three/examples/jsm/shaders/CopyShader");
    const { Pass } = require( "three/examples/jsm/postprocessing/Pass");

    console.log(resolution, scene, camera,)
